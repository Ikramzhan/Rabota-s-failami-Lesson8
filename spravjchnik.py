...
def read_file_to_dict(file_name):
    ...
    headers = ['Фамилия', 'Имя', 'Отчество' 'Статус' 'Класс' 'Номер телефона']
    contact_list = []
    for line in lines:
...
def find_number(contact_list):
    ...
    search_value_dict = {'1': 'Фамилия', '2': 'Имя', '3': 'Отчество', '4': 'Статус', '5': 'Класс', '6': 'Номер телефона'}
    found_contacts = []
...
def get_new_number():
    ...
    full_name = input('Введите отчество: ')
    status_name = input('Введите учитель или ученик: ')
    class_name = input('Введите класс: ')
    phone_number = input('Введите номер телефона: ')
    return last_name, first_name, full_name, status_name, class_name,  phone_number 
...
def change_phone_number(file_name):
    ...
    if field == '1':
        ...
        number_to_change[2] = input('Введите статус: ')
    elif field == '5':
        number_to_change[2] = input('Введите класс: ')
    elif field == '6':
